...
@Component({
  selector: 'app-fst-dashboard',
  templateUrl: './fst-dashboard.component.html',
  styleUrls: ['./fst-dashboard.component.scss']
})
export class FstDashboardComponent implements OnInit {
